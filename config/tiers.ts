...
export const TIERS_EN: Array<Tier> = [
  {
    ...
    description: "Sign up to get 50 free credits for code visualization and explanation.",
    features: [
      "50 free credits",
...
export const TIERS_ZH: Array<Tier> = [
  {
    ...
    price: "免费",
    href: siteConfig.openSourceURL || "#",
    description: "注册即可获得50个免费积分用于代码可视化和解释。",
    features: [
      "50个免费积分",
      "代码结构可视化",
      "AI代码解释",
...
export const TIERS_JA: Array<Tier> = [
  {
    ...
    price: "無料",
    href: siteConfig.openSourceURL || "#",
    description: "サインアップして、コードの可視化と説明のための50個の無料クレジットを取得できます。",
    features: [
      "50個の無料クレジット",
      "コード構造の可視化",
      "AI駆動のコード説明",
...
export const TIERS_AR: Array<Tier> = [
  {
    ...
    price: "مجاناً",
    href: siteConfig.openSourceURL || "#",
    description: "سجل للحصول على 50 رصيد مجاني لتصور الكود وشرحه.",
    features: [
      "50 رصيد مجاني",
      "تصور هيكل الكود",
...
export const TIERS_ES: Array<Tier> = [
  {
    ...
    price: "Gratis",
    href: siteConfig.openSourceURL || "#",
    description: "Regístrate para obtener 50 créditos gratuitos para visualización y explicación de código.",
    features: [
      "50 créditos gratuitos",
...
export const TIERS_RU: Array<Tier> = [
  {
    ...
    price: "Бесплатно",
    href: siteConfig.openSourceURL || "#",
    description: "Зарегистрируйтесь и получите 50 бесплатных кредитов для визуализации и объяснения кода.",
    features: [
